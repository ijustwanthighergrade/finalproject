var buyArray = [
    {id:1,img:"Testimg.jpg",title:"說書人",price:12,much:1,amount:0},
    {id:2,img:"game/心機/印加寶藏.jpg",title:"古墓企鵝",price:12,much:1,amount:0},
    {id:3,img:"Testimg.jpg",title:"說書人",price:12,much:2,amount:0},
];
...
function cancel(data){ /*刪除資料*/ /*這怎麼寫啊哭阿*/ 
    let checkcencel = confirm("確定取消訂單?如按確認則訂單取消，若要保留請按取消。");
    if (checkcencel) {
        data=-1; /*萬一他刪掉的話much的傳回值要+1 這邊只是為了讓他刪除資料而已*/ 
    }
    else
        data=1;
}
...
function TotalPrice(){
    ...
    let sumall = 0, dealcal=""; 
    let howmuch = 0, howmuchcancel = 0;
            ...
            dealcal+= `<div class="cart"> 
                            ...
                            <div class="much commotext">
                                <div >
                                    ...
                                    <input type="text" class="much commotext" value="${buyArray[i].much}" name="" id="commodityhowmuch">
    ...
    /*這塊列印表單跟確認送出*/
    tp.innerHTML = `<div class="totalframe">
...
var pushdata =  function() {
    ...
    // 電子郵件
    var howmuch = $('#commodityhowmuch').val() || '未填寫'; //商品數量
